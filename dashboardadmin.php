            ...
            <div class="row text-white">
              <div class="card bg-info ml-5" style="width: 18rem;">
                <div class="card-body">
                  ...
                  <a href="dashboardadminfilm.php" class="btn btn-primary mt-5">Lihat Detail</a></i></p></a>
                </div>
              </div>
              ...
              <div class="card bg-success ml-5" style="width: 18rem;">
                <div class="card-body">
                  ...
                  <a href="dashboardadminuser.php" class="btn btn-primary mt-5">Lihat Detail</a></i></p></a>
                </div>
              </div>
              ...
              <div class="card bg-danger ml-5 " style="width: 18rem;">
                <div class="card-body">
                  <div class="card-body-icon">
                    <i class="fas fa-money-bill-wave-alt mr-4"></i>
                  </div>
                  <h5 class="card-title">Transaksi</h5>
                  <a href="Peminjaman(Kelompok).php" class="btn btn-primary mt-5">Lihat Detail</a>
              </div>
            </div>
