  ...
  <body>
      ...
      <div class="row no-gutters mt-5 ">
        ...
        <div class="col-md-10 p-5 pt-2">
            <div class="row">
            <h3 class="col"><i class="fas fa-couch mr-2"></i>Kursi</h3>
            <div class="col" align="right"><a href="dashboardadminkursi_reset.php" class="btn btn-danger"><h3><i class="fas fa-trash-restore"></i></h3></a></div>
            </div>
            ...
            <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Nama Kursi</th>
                    <th scope="col">Status</th>
                    <th scope="col">Studio</th>
                    <th scope="col">Waktu</th>
                  </tr>
                  <?php $query = mysqli_query ($koneksi," select * from kursi order by id_kursi"); ?>
