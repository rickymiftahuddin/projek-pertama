  ...
  <body>
      ...
      <div class="row no-gutters mt-5 ">
        ...
        <div class="col-md-10 p-5 pt-2">
            <div class="row">
            <h3><i class="fas fa-money-bill-wave-alt mr-2"></i>Transaksi</h3>
            <div class="col" align="right"><a href="dashboardadmintransaksi_reset.php" class="btn btn-danger"><h3><i class="fas fa-trash-restore"></i></h3></a></div>
            </div>
            ...
            <table class="table">
                <thead>
                  ...
                  <?php $query = mysqli_query ($koneksi," select * from checkout order by id_checkout"); ?>
                    ...
                    <?php while ($data = mysqli_fetch_array($query)):?>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="dashboardadmintransaksi_hapus.php?id=<?php echo $data['id_checkout']; ?>" onClick = "return confirm('Apakah anda ingin mengapus data ini?')" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                        </td>
