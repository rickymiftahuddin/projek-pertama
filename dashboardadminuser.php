  ...
  <body>
      ...
      <div class="row no-gutters mt-5 ">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            <h3><i class="fas fa-address-book mr-2"></i>User</h3>
            ...
            <table class="table">
                <thead>
                  ...
                  <?php $query = mysqli_query ($koneksi," select * from tbl_user order by nik"); ?>
                    ...
                    <?php while ($data = mysqli_fetch_array($query)):?>
                      ...
                      <tr>
                        ...
                        <td>
                            <a href="dashboardadminuser_edit.php?id=<?php echo $data['nik']; ?>" class="btn btn-info"><i class="fas fa-edit"></i></a>
                            <a href="dashboardadminuser_hapus.php?id=<?php echo $data['nik']; ?>" onClick = "return confirm('Apakah Anda ingin mengapus data ini?')" class="btn btn-danger"><i class="fas fa-trash-alt"></i></a>
                        </td>
